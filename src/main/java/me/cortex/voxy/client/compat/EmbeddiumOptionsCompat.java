...
public final class EmbeddiumOptionsCompat {
    ...
    private static OptionPage buildPage() {
        OptionGroup general = OptionGroup.createBuilder()
                ...
                .add(booleanOption(
                        ...
                        (cfg, value) -> cfg.enableRendering = value,
                ...
                .add(booleanOption(
                        ...
                        (cfg, value) -> cfg.ingestEnabled = value,
        ...
        OptionGroup performance = OptionGroup.createBuilder()
                ...
                .add(intSliderOption(
                        ...
                        (cfg, value) -> cfg.sectionRenderDistance = value,
                        cfg -> cfg.sectionRenderDistance,
                        OptionImpact.HIGH,
                ...
                .add(intSliderOption(
                        ...
                        (cfg, value) -> cfg.serviceThreads = value,
                ...
                .add(booleanOption(
                        ...
                        (cfg, value) -> cfg.dontUseEmbeddiumBuilderThreads = !value,
                ...
                .add(intSliderOption(
                        ...
                        (cfg, value) -> cfg.subDivisionSize = value,
                        cfg -> Math.round(cfg.subDivisionSize),
                        OptionImpact.MEDIUM))
                .build();
        ...
        OptionGroup rendering = OptionGroup.createBuilder()
                ...
                .add(booleanOption(
                        ...
                        (cfg, value) -> cfg.useEnvironmentalFog = value,
                ...
                .add(booleanOption(
                        ...
                        (cfg, value) -> cfg.enableShaderPackFogOverride = value,
                        cfg -> cfg.enableShaderPackFogOverride,
                        OptionImpact.LOW))
                .add(booleanOption(
                        ...
                        (cfg, value) -> cfg.enableShaderPackFallbackPatch = value,
                        cfg -> cfg.enableShaderPackFallbackPatch,
                        OptionImpact.LOW,
                        OptionFlag.REQUIRES_RENDERER_RELOAD))
                .add(intSliderOption(
                        "lod_boundary_buffer",
                        ...
                        (cfg, value) -> cfg.lodBoundaryBuffer = value,
                        cfg -> cfg.lodBoundaryBuffer,
                        OptionImpact.LOW))
                .add(intSliderOption(
                        "earth_curve_ratio",
                        ...
                        (cfg, value) -> cfg.earthCurveRatio = value,
                        cfg -> cfg.earthCurveRatio,
                        OptionImpact.LOW))
                .build();
    ...
    private static final class VoxyConfigStorage implements OptionStorage<VoxyConfig> {
        ...
        public void save() {
            ...
            if (renderer != null) {
                renderer.setRenderDistance(VoxyConfig.CONFIG.sectionRenderDistance);
            }
        }
    }
}
